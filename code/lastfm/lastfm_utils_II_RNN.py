...
class II_RNNDataHandler:
    ...
    def store_user_session_representations(self, session_representations, user_list):
        # TODO: Don't know for sure how this needs to be implemented yet
        #   but something like:
        print("CONTROL THAT store_user_session_representations IN UTILS IS PROPERLY DONE!")
        for i in range(len(session_representations)):
            user = user_list[i]
